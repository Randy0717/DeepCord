from osrm_router1 import TSP_route
...
def excute(decision, assignment, demand_current, zone_lookup, TSP_route, ETA_Transit, geodistance, mode):
    ...
    if decision is not None:
        ...
        if a == 0:
            ...
            new_route = None
            new_route_time = None
            feedback = [s, a, reward, 1, [origin,dest]]
            ...
            if len(new_route) == 0:
                ...
                if contradiction == 1:
                    ...
                    revenue = beta0 + beta1 * direct_distance
                    x[1] -= 1
                    ...
                    if mode == 'CP+TR':
                        ...
                        index = a - 1
                        zone = demand_current.loc[r_id, 'dzone']

                    x[0] = s[11 + 2*index]
                    origin, dest = s[11 + 2 * index], s[12 + 2 * index]
                ...
                feedback = [s, a, reward, pickup_time[0]+1, [origin, dest]]
    ...
    return feedback, x, new_route, new_route_time, revenue
